...
import { StyleSheet, View, Text, Image, Platform, ScrollView, Alert } from 'react-native';
...
const PlantSave = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {Platform.OS === 'android' && <TouchableOpacity style={styles.dateTimePickerButton} onPress={handleOpenDateTimePickerAndroid}><Text style={styles.dateTimePickerText}>{`Mudar ${format(selectedDateTime, 'HH:mm')}`}</Text></TouchableOpacity>}
